...
test.describe("OpenCoreAnimation smoke", () => {
    ...
    test("rendering: WebGPU readback contains layer colors", async ({ harness }) => {
        ...
        await expect.poll(() => h.getCompositionProbeResult(), { timeout: 10_000 }).toBe(
            "ordered=true,pixels=0,0,0,255;255,255,0,255;127,0,0,255;0,0,255,255;0,255,255,255;255,0,0,255;7,135,10,192;127,0,0,255;255,255,0,255;255,0,0,255;255,0,0,255;255,128,0,255;127,0,0,255;128,128,0,255;255,0,255,255;255,255,0,255;255,0,0,255;255,0,0,255;255,0,0,255;0,255,255,255;255,0,0,255;255,0,0,255,failures=0,after=0"
        );
