...
test.describe("OpenCoreAnimation smoke", () => {
    ...
    test("rendering: WebGPU readback contains layer colors", async ({ harness }) => {
        ...
        await expect.poll(
            ...
            "0,128,0,255;0,0,0,255;255,255,0,255;0,0,0,255;0,0,0,255;255,0,0,255;0,255,0,255;255,0,0,255;0,255,0,255;128,0,0,255;0,64,0,255;0,128,0,255;64,128,0,255;0,64,0,255;0,255,0,255;255,0,255,255;0,255,255,255;255,0,255,255;255,255,0,255;255,255,0,255;0,128,128,255,overflowTyped=true,overflowPending=true,maskOverflowTyped=true,maskOverflowPending=true,contentsOverflowTyped=true,contentsOverflowPending=true,snapshotMaskFailureTyped=true,snapshotMaskFailurePending=true,snapshotMaskFailureRecovered=true,snapshotShadowFailureTyped=true,snapshotShadowFailurePending=true,snapshotShadowFailureRecovered=true,snapshotFilterFailureTyped=true,snapshotFilterFailurePending=true,snapshotCompositionFailureTyped=true,snapshotCompositionFailurePending=true,snapshotRasterScale=true,snapshotRasterFailureTyped=true,snapshotRasterFailurePending=true,delegateCaptured=true,snapshotPending=true,snapshotCompleted=true,delegateFailureTyped=true,delegateFailurePending=true"
        );
