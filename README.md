...
| Hit testing | Normal and transform-layer trees traverse the same stable `zPosition` order as rendering. `CATransformLayer` converts the incoming superlayer-space point once before forwarding it, and never returns itself |
