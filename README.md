...
| Remaining boundary | Core Image transition types without executable WGSL remain unavailable. Effect-bearing descendants or compositing/background/transition effects inside the mask layer tree are explicitly rejected pending recursive mask-effect propagation; complete QuartzCore parity is not claimed |
