...
| Remaining boundary | Core Image transition types without executable WGSL remain unavailable. Compositing, background-filter, or transition effects inside the mask layer tree are explicitly rejected pending recursive backdrop propagation; complete QuartzCore parity is not claimed |
